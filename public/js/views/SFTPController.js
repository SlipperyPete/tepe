define(['jquery', 'underscore', 'backbone', 'js/views/FileTreeView', 'bootstrap', 'context'],
			...
			initialize : function() {
				...
				$("#create-folder").click(function() {
					...
					$.ajax({
						...
						success: function(resp){
							//insert the shit
							window.lastContextFolderDOM.find(".folders-container").first().append('<div class="tree-node" style="padding-left:12px;">' + '<div class="name-info">' + '<span class="toggle-folder" data-fetched="0" data-location="'+fileName+'">&#9654;</span>' + '<span class="node-name">' + $("#folderName").val() + '</span>' + '</div>' + '<div class="folders-container" style="display:none;">' + '</div>' + '<div class="files-container" style="display:none;">' + '</div>' + '</div>');
							// window.lastContextFolderDOM.find(".toggle-folder")                
